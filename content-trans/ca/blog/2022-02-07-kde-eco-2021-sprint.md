...
Quan es mesura el consum d'energia en un laboratori, en particular per a l'ecocertificació de Blauer Engel, es poden generar tres tipus de fitxers de dades: (i) un fitxer de registre d'accions (vegeu més amunt la reautomatització d'aquests fitxers de registres), (ii) dades de rendiment de maquinari (CPU, RAM, etc.), i (iii) ús d'energia elèctrica. Com que en alguns casos les dades de sortida hauran de ser autodefinides (per exemple, registres de codis de temps en scripts de «xdotool»), hem de considerar com haurien de ser les dades abans de mesurar-les al laboratori.
