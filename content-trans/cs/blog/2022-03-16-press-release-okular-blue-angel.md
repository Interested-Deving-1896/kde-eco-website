...
---
{{< img figure_class="text-center" src="/blog/images/okular-main_w_logos_cleantitle.png" alt=`Snímek aplikace Okular` >}}

{{< img figure_class="float-end floating-figure" src="/blog/images/hisc-apps-okular.svg" caption=`Ikona Okularu` >}}
