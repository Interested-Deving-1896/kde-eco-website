...
- Okular
- Blauer Engel
- Globaal Ecolabelling Netwerk
- Onderhoudbaarheid
date: 2022-03-16
publishDate: 2022-03-16 09:00:00+01:00
scssFiles:
- scss/20220316.scss
subtitle: Het multi-platform Vrije en Open-Source Softwareproduct is nu officieel
  erkent voor duurzaam software ontwerp
summary: Persuitgave om het ontvangen van het Blue Angel eco-label door Okular aan
  te kondigen.
title: 'Eerste ooit Eco-gecertificeerd computer programma: KDE''s Populaire PDF-lezer
  Okular'
---
{{< img figure_class="text-center" src="/blog/images/okular-main_w_logos_cleantitle.png" alt=`Schermafdruk van Okular` >}}

{{< img figure_class="float-end floating-figure" src="/blog/images/hisc-apps-okular.svg" caption=`Pictogram van Okular` >}}
...
{{< img figure_class="float-start floating-figure w-30" src="/images/rees-en.svg" caption=`Ecolabel Bleu Angel` >}}
