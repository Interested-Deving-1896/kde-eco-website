...
Free Software guarantees, by design, [transparency and user autonomy](https://fsfe.org/freesoftware/index.en.html). This gives *YOU*, the user, control of *YOUR* hardware by removing unnecessary vendor dependencies. With Free Software, you are able to use your device how you want, for as long as you want. You can remove [bloatware](https://en.wikipedia.org/wiki/Software_bloat) or stop [unwanted data use and ads](https://groenlinks.nl/sites/groenlinks/files/2021-09/CE_Delft_210166_Carbon_footprint_unwanted_data-use_smartphones.pdf) from driving up energy demands and slowing down your device (while shutting the door to uninvited snooping in your private life as well). With software made for your needs, not the vendors', you can choose applications designed for the hardware you already own. Say goodbye to premature hardware obsolescence &mdash; lean, efficient Free Software runs on devices that are decades old!
...
Over the next two years, the "Opt Green" initiative will take all that KDE Eco has been doing for sustainable software directly to end users. A particular target group for the project is eco-consumers, that is, those whose consumer behavior is driven by principles related to the environment, and not just price or convenience.
...
For consumers, the environmental harm may be out-of-sight and out-of-mind. Yet the environment is registering its effects, from the C02 pumped into the atmosphere to the landfills that receive our discarded devices at their end of life -- as well as the air, soil, and waters around them, not to mention the people and animals.
...
Free Software already gives consumers what they want, but most consumers don't know it yet. Transparency makes lightweight, highly performative software a reality, even on much older devices, while user autonomy ensures the right to repair when applications stop functioning.
