...
<!--![Photograph of e-waste. (Image published under a [CC0-1.0](https://spdx.org/licenses/CC0-1.0.html) public domain license.)](images/sec1_e-waste.jpg){width=600px height=400px}-->

Before we dive into the environmental impact of software, consider how you would complete this sentence:

\centerline{\textbf{The most environmentally-friendly device is …}}
...
![Image from KDE Eco [leaflet](https://invent.kde.org/teams/eco/opt-green/-/blob/master/materials/leaflets/EN/kde-eco-umweltfestival-flyer-EN_final.jpg) (modified) published under a [CC-BY-SA-4.0](https://spdx.org/licenses/CC-BY-SA-4.0.html) license.](images/sec1_leaflet.png){width=600px height=182px latex-placement="hb"}
...
![XKCD comic ["2368: Bigger Problem"](https://xkcd.com/2368/) (published under a [CC-BY-NC-2.5](https://spdx.org/licenses/CC-BY-NC-2.5.html) license).](images/sec1_bigger_problem.png){width=600px height=250px}
...
![Screenshot illustrating the four essential freedoms to use, study, share, and improve software. Image from video "What is Free Software (Open Source)? Software freedom explained in less than three minutes!" from the FSFE.](images/sec2_fsfe-free-software.png){width=500px height=268px}
...
\begin{center}\textbf{The most environmentally-friendly device is the one you already own.}\end{center}
...
![Screenshot from KDE Eco blog showing a command line interface in [Konsole](https://apps.kde.org/konsole/). This is really scary to many new users! (Screenshot from Aakarsh MJ published under a [CC-BY-4.0](https://spdx.org/licenses/CC-BY-4.0.html) license.)](images/sec3_konsole.png){width=400px height=225px}
...
![XKCD comic ["627: Tech Support Cheat Sheet"](https://xkcd.com/627/) (published under a [CC-BY-NC-2.5](https://spdx.org/licenses/CC-BY-NC-2.5.html) license).](images/sec3_tech_support_cheat_sheet.png){width=400px height=450px}
...
![Screenshot of [KDE's forum](https://discuss.kde.org/), where users can ask and answer questions about KDE Plasma on various distros.](images/sec3_discuss-kde-org.png){width=550px height=245px}
...
![Plasma Mobile is an open-source user interface for mobile devices developed by the KDE community. (Image from KDE released under a [CC-BY-4.0](https://spdx.org/licenses/CC-BY-4.0.html) license.)](images/sec3_plasmaphone.png){width=200px height=431px}
